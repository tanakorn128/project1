...
<title>Admin</title>
<body style="background-color:pink;" font-size:medium;>
...
<center>
<input type = button value = "กล่องจดหมาย" onclick='location.replace("")' class="button1">
<input type = button value = "เพิ่มหัวข้อ/เช็กชื่อ" onclick='location.replace("")' class="button1">
<input type = button value = "ประวัติ" onclick='location.replace("")' class="button1">
